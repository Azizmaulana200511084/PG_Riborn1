...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self._matakuliah_action = self.add_action("Matakuliah", "matakuliah", "Data Matakuliah", True, self.on_matakuliah_file)
        self._mahasiswa_action = self.add_action("Mahasiswa", "mahasiswa", "Data Mahasiswa", True, self.on_mahasiswa)
        self._dosen_action = self.add_action("Dosen", "dosen", "Data Dosen", True, self.on_dosen)
        self._alumni_action = self.add_action("Alumni", "alumni", "Data Alumni", True, self.on_alumni)
